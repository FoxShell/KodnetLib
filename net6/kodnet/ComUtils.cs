...
namespace FoxShell{
	...
	public static class DispatchUtility
	{
		...
		public static TypeInfo GetTypeInfo(object obj, bool throwIfNotFound)
		{
			RequireReference(obj, "obj");
			TypeInfo result = GetTypeInfo((IDispatchInfo)obj, throwIfNotFound);
			return result;
		}
		...
		/// <param name="throwIfNotFound">Whether an exception should be thrown if a Type can't be obtained.</param>
		/// <returns>A .NET Type that can be used with reflection.</returns>
		private static TypeInfo GetTypeInfo(IDispatchInfo dispatch, bool throwIfNotFound)
		{
		...
		private interface IDispatchInfo
		{
			...
			/// </remarks>
			void GetTypeInfo(int typeInfoIndex, int lcid,  out TypeInfo typeInfo);
